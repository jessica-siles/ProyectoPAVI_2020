...
namespace ProyectoGrupalGestionDeUsuarios.DataAccessLayer
{
    public class PermisosDao
    {
        ...
        public bool eliminartodos(int perfil, List<int>quitar, string fecha)
        {
        ...
        {
            string consulta = "SELECT Formularios.boton_name,Permisos.id_formulario,Permisos.id_perfil FROM Permisos " +
                              "INNER JOIN Perfiles ON Perfiles.id_perfil = Permisos.id_perfil " +
                              "INNER JOIN Usuarios ON Usuarios.id_perfil = Perfiles.id_perfil " +
                              "INNER JOIN Formularios ON Formularios.id_formulario = Permisos.id_formulario " +
